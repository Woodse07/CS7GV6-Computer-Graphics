...
GLuint generateObjectBuffer(GLfloat vertices[], GLfloat colors[]) {
	GLuint numVertices = vertexes_shape;
	...
	// After b1ng, we now fill our object with data, everything in "Vertices" goes to the GPU
...
void display() {
	...
	glDrawArrays(GL_TRIANGLES, 0, vertexes_shape);
	glutSwapBuffers();
}
...
void init()
{
	...
	// Square
	// Create 6 vertices that make up a square out of 2 triangles
	GLfloat vertices[] = {
						// first triangle
	...
	GLfloat colors[] = { 
		                // first triangle
						 ...
						 1.0f, 0.0f, 0.0f, 1.0f, // bottom right red
